...
#define SERVO_SG90_TOWER_PRO_MIN_PULSE_WIDTH_US     500UL
#define SERVO_SG90_TOWER_PRO_MIN_PULSE_WIDTH_US     2500UL

#define SERVO_MIN_PULSE_WIDTH_US        500UL
#define SERVO_MAX_PULSE_WIDTH_US        2500UL
